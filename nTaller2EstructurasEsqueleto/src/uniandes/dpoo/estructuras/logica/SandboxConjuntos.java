...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    	...
    	NavigableSet<String> nuevoArbol = arbolCadenas.descendingSet();
    	
    	List<String> nuevaLista = new ArrayList<>(nuevoArbol);
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        for (String letra: arbolCadenas) {
            ...
            if (letra.compareTo(cadena)>= 0) {
                nuevaLista.add(letra);
            }
        }
        return nuevaLista;
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        for (String s : arbolCadenas) {
            if (s.toLowerCase().equals(cadenaFinal)) {
            	cadenaEliminar = s;  
                break;
            }
        }
    ...
    public void volverMayusculas( )
    {
    	...
    	for(String cadena : arbolCadenas ) {
    		String nCadena = cadena.toUpperCase();
    		nuevaLista.add(nCadena);
    		
    	}
    	NavigableSet<String> nuevoN = new TreeSet<String>(nuevaLista);
    	arbolCadenas = nuevoN;
    }
